...
export default function Banner() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 transition-transform duration-300">
      ...
      <div className="flex flex-1 justify-end">
        <button
          type="button"
          className="-m-3 p-3 text-black focus-visible:outline-offset-[-4px]"
          onClick={handleClose}
        >
